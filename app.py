...
#def crawl_internal_pages(start_url, max_pages=50): # original max_pages=10
...
st.title("Chatbot for all Autism Spectrum Disorder (ASD) related queries")
...
#                        "Please try a different approved site or upload a PDF instead."
#                    )
#                else:
...
# Sidebar input: allow comma-separated URLs
